...
def get_task_embs(cfg, descriptions):
    ...
    if cfg.task_embedding_format == "bert" or cfg.task_embedding_format == "one-hot":
        tz = AutoTokenizer.from_pretrained(
            "bert/bert-base-cased", cache_dir=to_absolute_path("bert")
        )
        ...
        masks = tokens["attention_mask"]  # mask shape: torch.Size([10, 25])
        input_ids = tokens["input_ids"]  # input shape: torch.Size([10, 25])
