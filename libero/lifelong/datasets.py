...
def get_dataset(
    ...
    **kwargs
    ...
    if load_previous_action:
        dataset_keys = ["actions", "previous_actions"]
    else:
    ...
    dataset = SequenceDataset(
        ...
        load_next_obs=False,  # LIBERO提供的数据集里不自带next_obs，若为True需要自己添加
        ...
        hdf5_use_swmr=True,
        hdf5_normalize_obs=False,  # 没有使用单位均值、方差归一化
